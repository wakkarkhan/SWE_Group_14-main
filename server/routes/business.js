...
// Route to create a review for specefic business
router.post('/:id/review', businessController.createReviewForBusiness);

// Route to get * all reviews for specefic business
router.get('/:id/reviews', businessController.getReviewsForBusiness);
